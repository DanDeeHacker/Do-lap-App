...
export const METRIC_INFO: Record<string, string> = {
  ...
  readiness:
    "Připravenost (20–100 %) = jak daleko jsou dnes vaše ukazatele regenerace od VAŠÍ normy (posledních 8 týdnů): HRV pod normou a klidový tep nad normou — z poslední noci i z průměru 7 nocí, který je spolehlivější a počítá se silněji (to, co hodinky ukazují jako stav HRV) — kratší spánek a svalová bolest / únava z check-inu. Odchylka do 0,5 SD je běžný šum a nic nestojí; čím větší odchylka, tím nižší připravenost. Shodné signály se sčítají: HRV i klidový tep asi 1 SD mimo normu → kolem 70 %, 1,5 SD → 40 %. Kapacitu (Zátěž) připravenost zmenšuje nejvýš o 30 %.",
  relEffort:
  ...
  readinessTraining:
    "Připravenost (20–100 %) = odchylka HRV, klidového tepu (poslední noc i průměr 7 nocí), spánku a check-inu od vaší normy za 8 týdnů. HRV i klidový tep ~1 SD mimo normu → kolem 70 %, ~1,5 SD → 40 %. Pod 65 % dnes bez tvrdého tréninku a dlouhého běhu, pod 45 % jen regenerace; zmenšuje i dnešní strop na jeden běh. Týdenní cíl z cyklu nemění.",
}

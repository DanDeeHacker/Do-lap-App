...
KNOBS = [
    ...
    {"id": "sessionSpike", "axis": "load", "label": "Skok v jednom běhu", "grade": "B", "unit": "×",
    ...
    {"id": "spikeLatent", "axis": "load", "label": "Doznívající skok", "grade": "B", "unit": "",
    ...
    {"id": "hiAcute", "axis": "load", "label": "Tvrdá práce 7 dní", "grade": "B", "unit": "j.z.",
    ...
    {"id": "hiRatio", "axis": "load", "label": "Skok ve vysoké intenzitě", "grade": "B", "unit": "×",
    ...
    {"id": "loadCreep", "axis": "load", "label": "Postupný nárůst zátěže", "grade": "C", "unit": "×",
    ...
    {"id": "descentSpike", "axis": "load", "label": "Nárůst sbíhání", "grade": "C", "unit": "×",
    ...
    {"id": "rhrZ", "axis": "load", "label": "Klidový tep (z-skóre)", "grade": "B", "unit": "z",
    ...
    {"id": "hrvCvRatio", "axis": "load", "label": "Kolísání HRV mezi dny", "grade": "C", "unit": "×",
     "min": 0.6, "max": 2.5, "step": 0.01, "default": 1.0, "thr": 1.4, "dir": "above",
     "desc": "Den-k-dni variabilita HRV vs. obvyklá."},
    {"id": "tsbRel", "axis": "load", "label": "Bilance zátěže (TSB/chronická)", "grade": "C", "unit": "",
...
def simulate(inp: dict, prev_quadrant: str | None = None) -> dict:
    ...
    load_f = rnd(clamp(load * frailty, 0, 100))
    symp_f = rnd(clamp(symp, 0, 100))
    overall = rnd(clamp(mech_f * 0.38 + load_f * 0.30 + symp_f * 0.52, 0, 100))
...
def sweep(inp: dict, knob_id: str, n: int = 41, prev_quadrant: str | None = None) -> dict:
    ...
    series = []
    for v in values:
        r = simulate({**base, knob_id: v}, prev_quadrant)
